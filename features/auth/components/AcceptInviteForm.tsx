 ...
 *
 * By the time the user reaches /accept-invite, the /auth/callback route handler
 * has already exchanged the token_hash for a real session (server-side).
...
export function AcceptInviteForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Update the password — session is already active from /auth/callback
