...
export function ConversationDetails({
  ...
  if (!conversation) {
    return (
      <div className="flex h-full w-[260px] shrink-0 flex-col items-center justify-center border-l border-border/50 bg-sidebar p-6 text-center">
      ...
      <div className="flex flex-col items-center px-4 pt-6 pb-5">
        ...
        {conversation.customer_phone && (
          <a
            ...
            className="mt-3 flex items-center gap-1.5 rounded-full bg-[#25D366]/15 border border-[#25D366]/25 px-4 py-1.5 text-xs font-semibold text-[#25D366] transition-colors hover:bg-[#25D366]/20 uppercase tracking-wide"
          >
